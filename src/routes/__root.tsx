...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Escuela de Baile Lucy Arroyo | Donde el arte cobra vida" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Escuela de Baile Lucy Arroyo" },
      {
      ...
      { name: "twitter:title", content: "Escuela de Baile Lucy Arroyo" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;0,800;1,400&family=Manrope:wght@300;400;500;600;700;800&display=swap",
      },
    ],
  }),
